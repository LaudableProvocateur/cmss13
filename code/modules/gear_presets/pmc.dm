		...
		if(2) //Light with a nsg23 rifle (UBS+reflex sight+supressor) / fp9000 pmc version
			...
			switch(rand(1,2))
				...
				if(2)
					...
					new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/nsg23/extended, WEAR_IN_JACKET)
					new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_12/buckshot, WEAR_IN_BACK)
					new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_12/buckshot, WEAR_IN_BACK)
...
/datum/equipment_preset/pmc/pmc_riot_control/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/slug/es7, WEAR_IN_BELT)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/slug/es7, WEAR_IN_BELT)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/slug/es7, WEAR_IN_BELT)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/slug/es7, WEAR_IN_BELT)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/slug/es7, WEAR_IN_BELT)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/slug/es7, WEAR_IN_BELT)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/slug/es7, WEAR_IN_BELT)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/beanbag/es7, WEAR_IN_BELT)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/beanbag/es7, WEAR_IN_BELT)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/beanbag/es7, WEAR_IN_BELT)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/beanbag/es7, WEAR_IN_BELT)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/beanbag/es7, WEAR_IN_BELT)

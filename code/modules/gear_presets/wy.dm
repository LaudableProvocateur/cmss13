...
/datum/equipment_preset/wy/security/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/beanbag/es7, WEAR_IN_L_STORE)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/beanbag/es7, WEAR_IN_L_STORE)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/beanbag/es7, WEAR_IN_L_STORE)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/beanbag/es7, WEAR_IN_L_STORE)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/beanbag/es7, WEAR_IN_L_STORE)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/slug/es7, WEAR_IN_L_STORE)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_20/slug/es7, WEAR_IN_L_STORE)

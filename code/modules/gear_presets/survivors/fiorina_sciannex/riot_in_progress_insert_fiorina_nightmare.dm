...
/datum/equipment_preset/survivor/cmb/ua/load_gear(mob/living/carbon/human/new_human)
	...
	switch(choice)
		...
		if(8)
			...
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/m4a3, WEAR_IN_ACCESSORY)
		...
		if(9 to 10)
			new_human.equip_to_slot_or_del(new /obj/item/clothing/accessory/storage/holster, WEAR_ACCESSORY)
			new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/pistol/mk45/black, WEAR_IN_ACCESSORY)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/mk_45, WEAR_IN_ACCESSORY)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/mk_45, WEAR_IN_ACCESSORY)
			new_human.equip_to_slot_or_del(new /obj/item/explosive/plastic/breaching_charge/rubber, WEAR_IN_BACK)

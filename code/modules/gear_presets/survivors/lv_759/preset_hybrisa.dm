...
/datum/equipment_preset/survivor/hybrisa/pizza_galaxy/load_gear(mob/living/carbon/human/new_human)
	...
	switch(random_gear)
		...
		if(60 to 65) // Pizza Delivery (Very Rare)
			...
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_12/buckshot(new_human), WEAR_IN_R_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_12/buckshot(new_human), WEAR_IN_R_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_12/buckshot(new_human), WEAR_IN_R_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_12/buckshot(new_human), WEAR_IN_R_STORE)
	add_survivor_weapon_civilian(new_human)
...
/datum/equipment_preset/survivor/hybrisa/nspa_constable/load_gear(mob/living/carbon/human/new_human)
	...
	switch(choice)
		...
		if(50 to 75)
			...
			new_human.equip_to_slot_or_del(new /obj/item/storage/pouch/shotgun(new_human), WEAR_R_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_12/buckshot(new_human), WEAR_IN_R_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_12/slug(new_human), WEAR_IN_R_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_12/slug(new_human), WEAR_IN_R_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_12/beanbag(new_human), WEAR_IN_R_STORE)

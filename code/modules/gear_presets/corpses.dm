...
/datum/equipment_preset/corpse/pizza/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/pistol/w62, WEAR_IN_BACK)
...
/datum/equipment_preset/corpse/hybrisa/nspa_constable/load_gear(mob/living/carbon/human/new_human)
	...
	switch(choice)
		...
		if(8 to 10)
			...
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_12/slug, WEAR_IN_R_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/gauge_12/slug, WEAR_IN_R_STORE)

...
/obj/structure/machinery/cm_vending/sorted/vehicle_supply/populate_product_list(scale)
	listed_products = list(
		...
		list("Box Of Buckshot Shells", floor(scale * 3), /obj/item/ammo_magazine/shell_box/gauge_12/buckshot, VENDOR_ITEM_REGULAR),
		list("Box Of Flechette Shells", floor(scale * 2), /obj/item/ammo_magazine/shell_box/gauge_12/flechette, VENDOR_ITEM_REGULAR),
		list("Box Of Shotgun Slugs", floor(scale * 4), /obj/item/ammo_magazine/shell_box/gauge_12/slug, VENDOR_ITEM_REGULAR),
		...
		list("M44 Speed Loader (.44)", floor(scale * 4), /obj/item/ammo_magazine/revolver/m44, VENDOR_ITEM_REGULAR),
		list("M4A3 Magazine (9mm)", floor(scale * 10), /obj/item/ammo_magazine/m4a3, VENDOR_ITEM_REGULAR),
		...
		list("M4A3 AP Magazine (9mm)", 0, /obj/item/ammo_magazine/m4a3/ap, VENDOR_ITEM_REGULAR),
		...
		list("M44 Heavy Speed Loader (.44)", 0, /obj/item/ammo_magazine/revolver/m44/heavy, VENDOR_ITEM_REGULAR),
		list("M44 Marksman Speed Loader (.44)", 0, /obj/item/ammo_magazine/revolver/m44/marksman, VENDOR_ITEM_REGULAR),
		list("M4A3 HP Magazine (9mm)", 0, /obj/item/ammo_magazine/m4a3/hp, VENDOR_ITEM_REGULAR),
		...
		list("SU-6 Smartpistol Magazine (.45)", floor(scale * 2), /obj/item/ammo_magazine/pistol/su_6, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/vehicle_supply/tent/populate_product_list(scale)
	listed_products = list(
		...
		list("Box Of Buckshot Shells", 0, /obj/item/ammo_magazine/shell_box/gauge_12/buckshot, VENDOR_ITEM_REGULAR),
		list("Box Of Flechette Shells", 0, /obj/item/ammo_magazine/shell_box/gauge_12/flechette, VENDOR_ITEM_REGULAR),
		list("Box Of Shotgun Slugs", 0, /obj/item/ammo_magazine/shell_box/gauge_12/slug, VENDOR_ITEM_REGULAR),
		...
		list("M44 Speed Loader (.44)", 0, /obj/item/ammo_magazine/revolver/m44, VENDOR_ITEM_REGULAR),
		list("M4A3 Magazine (9mm)", 0, /obj/item/ammo_magazine/m4a3, VENDOR_ITEM_REGULAR),
		list("M56D Drum Magazine", 0, /obj/item/ammo_magazine/m56d, VENDOR_ITEM_REGULAR),
		list("M2C Box Magazine", 0, /obj/item/ammo_magazine/m2c, VENDOR_ITEM_REGULAR),

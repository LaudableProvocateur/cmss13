...
/obj/structure/machinery/cm_vending/sorted/vehicle_supply/populate_product_list(scale)
	listed_products = list(
		...
		list("Box Of Buckshot Shells", floor(scale * 3), /obj/item/ammo_magazine/gauge_12/buckshot, VENDOR_ITEM_REGULAR),
		list("Box Of Flechette Shells", floor(scale * 2), /obj/item/ammo_magazine/gauge_12/flechette, VENDOR_ITEM_REGULAR),
		list("Box Of Shotgun Slugs", floor(scale * 4), /obj/item/ammo_magazine/gauge_12/slug, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/vehicle_supply/tent/populate_product_list(scale)
	listed_products = list(
		...
		list("Box Of Buckshot Shells", 0, /obj/item/ammo_magazine/gauge_12/buckshot, VENDOR_ITEM_REGULAR),
		list("Box Of Flechette Shells", 0, /obj/item/ammo_magazine/gauge_12/flechette, VENDOR_ITEM_REGULAR),
		list("Box Of Shotgun Slugs", 0, /obj/item/ammo_magazine/gauge_12/slug, VENDOR_ITEM_REGULAR),

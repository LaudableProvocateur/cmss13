...
/obj/item/weapon/gun/bolt_action/vulture/update_icon()
	..()
...
/obj/item/weapon/gun/bolt_action/vulture/set_gun_config_values()
	..()
...
/obj/item/weapon/gun/bolt_action/vulture/set_gun_attachment_offsets()
	attachable_offset = list("muzzle_x" = 39, "muzzle_y" = 19, "rail_x" = 17, "rail_y" = 24, "under_x" = 31, "under_y" = 14, "stock_x" = 11, "stock_y" = 15)

/obj/item/weapon/gun/bolt_action/vulture/able_to_fire(mob/user)
...
/obj/item/weapon/gun/bolt_action/vulture/Fire(atom/target, mob/living/user, params, reflex, dual_wield)
...
/obj/item/weapon/gun/bolt_action/vulture/proc/fired_without_bipod(mob/living/user)
...
/obj/item/weapon/gun/bolt_action/vulture/proc/break_arm(mob/living/carbon/human/user, arm = LEFT)
...
/obj/item/weapon/gun/bolt_action/vulture/skillless
	bypass_trait = TRUE

/obj/item/weapon/gun/bolt_action/vulture/holo_target
	current_mag = /obj/item/ammo_magazine/rifle/boltaction/vulture/holo_target

/obj/item/weapon/gun/bolt_action/vulture/holo_target/skillless
	bypass_trait = TRUE

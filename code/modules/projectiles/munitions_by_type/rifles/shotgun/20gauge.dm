// no generic exists for this category as the uniqueness of each shell felt reasonable enough to merit developing individually
...
/obj/item/ammo_magazine/handful/gauge_20/es7_slug
	name = "handful of X21 solid slugs (20g)"
	icon_state = "es7_slug_5"
	default_ammo = /datum/ammo/bullet/gauge_20/es7_slug
	handful_state = "es7_slug"
	caliber = "20g"
/obj/item/ammo_magazine/handful/gauge_20/es7_beanbag

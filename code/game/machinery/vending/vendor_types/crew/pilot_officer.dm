...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/pilot_officer
	...
	listed_products = list(
		...
		list("M4A3 AP Magazine (9mm)", 12, /obj/item/ammo_magazine/m4a3/ap, VENDOR_ITEM_REGULAR),
		list("M4A3 HP Magazine (9mm)", 12, /obj/item/ammo_magazine/m4a3/hp, VENDOR_ITEM_REGULAR),

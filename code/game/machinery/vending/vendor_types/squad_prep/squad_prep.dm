...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad_prep/populate_product_list(scale)
	listed_products = list(
		...
		list("Box of Flechette Shells (12g)", floor(scale * 3), /obj/item/ammo_magazine/gauge_12/flechette, VENDOR_ITEM_REGULAR),
		list("Box of Buckshot Shells (12g)", floor(scale * 5), /obj/item/ammo_magazine/gauge_12/buckshot, VENDOR_ITEM_REGULAR),
		list("Box of Shotgun Slugs (12g)", floor(scale * 5), /obj/item/ammo_magazine/gauge_12/slug, VENDOR_ITEM_REGULAR),

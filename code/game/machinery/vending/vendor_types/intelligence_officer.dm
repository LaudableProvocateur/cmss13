...
GLOBAL_LIST_INIT(cm_vending_gear_intelligence_officer, list(
		...
		list("M4A3 HP Magazine", 5, /obj/item/ammo_magazine/m4a3/hp, null, VENDOR_ITEM_REGULAR),
		list("M4A3 AP Magazine", 5, /obj/item/ammo_magazine/m4a3/ap, null, VENDOR_ITEM_REGULAR),
		list("VP78 Magazine", 5, /obj/item/ammo_magazine/pistol/vp78, null, VENDOR_ITEM_REGULAR),
		list("SU-6 Smartpistol Magazine (.45)", 10, /obj/item/ammo_magazine/pistol/su_6, null, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_guns_intelligence_officer, list(
		...
		list("Box of Buckshot Shells (12g)", 12, /obj/item/ammo_magazine/shell_box/gauge_12/buckshot, VENDOR_ITEM_REGULAR),
		list("Box of Flechette Shells (12g)", 12, /obj/item/ammo_magazine/shell_box/gauge_12/flechette, VENDOR_ITEM_REGULAR),
		list("Box of Shotgun Slugs (12g)", 12, /obj/item/ammo_magazine/shell_box/gauge_12/slug, VENDOR_ITEM_REGULAR),
		...
		list("M4A3 Magazine (9mm)", 20, /obj/item/ammo_magazine/m4a3, VENDOR_ITEM_REGULAR),
		list("M4A3 AP Magazine (9mm)", 8, /obj/item/ammo_magazine/m4a3/ap, VENDOR_ITEM_REGULAR),
		list("M4A3 HP Magazine (9mm)", 8, /obj/item/ammo_magazine/m4a3/hp, VENDOR_ITEM_REGULAR),

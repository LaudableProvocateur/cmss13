...
/obj/structure/machinery/cm_vending/sorted/cargo_ammo/upp_cargo_ammo/populate_product_list(scale)
	listed_products = list(
		...
		list("Box of Heavy Buckshot Shells (8g)", floor(scale * 56), /obj/item/ammo_magazine/gauge_8/buckshot, VENDOR_ITEM_REGULAR),
		list("Box of Heavy Slugs (8g)", floor(scale * 56), /obj/item/ammo_magazine/gauge_8/slug, VENDOR_ITEM_REGULAR),
		list("Box of Heavy Flechette Shells (8g)", floor(scale * 56), /obj/item/ammo_magazine/gauge_8/flechette, VENDOR_ITEM_REGULAR),

...
/obj/structure/machinery/cm_vending/sorted/cargo_ammo/populate_product_list(scale)
	listed_products = list(
		...
		list("Box Of Buckshot Shells", floor(scale * 56), /obj/item/ammo_magazine/shell_box/gauge_12/buckshot, VENDOR_ITEM_REGULAR),
		list("Box Of Flechette Shells", floor(scale * 56), /obj/item/ammo_magazine/shell_box/gauge_12/flechette, VENDOR_ITEM_REGULAR),
		list("Box Of Shotgun Slugs", floor(scale * 56), /obj/item/ammo_magazine/shell_box/gauge_12/slug, VENDOR_ITEM_REGULAR),
		...
		list("M44 Speed Loader (.44)", floor(scale * 80), /obj/item/ammo_magazine/revolver/m44, VENDOR_ITEM_REGULAR),
		list("M4A3 Magazine (9mm)", floor(scale * 100), /obj/item/ammo_magazine/m4a3, VENDOR_ITEM_REGULAR),
		...
		list("M4A3 AP Magazine (9mm)", floor(scale * 2), /obj/item/ammo_magazine/m4a3/ap, VENDOR_ITEM_REGULAR),
		...
		list("M44 Heavy Speed Loader (.44)", 10, /obj/item/ammo_magazine/revolver/m44/heavy, VENDOR_ITEM_REGULAR),
		...
		list("SU-6 Smartpistol Magazine (.45)", 13, /obj/item/ammo_magazine/pistol/su_6, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad_prep/training/populate_product_list(scale)
	listed_products = list(
		...
		list("Box of Beanbag Shells (12g)", floor(scale * 15), /obj/item/ammo_magazine/shell_box/gauge_12/beanbag, VENDOR_ITEM_REGULAR),
		...
		list("M4A3 Rubber Magazine (9mm)", floor(scale * 25), /obj/item/ammo_magazine/m4a3/rubber, VENDOR_ITEM_REGULAR),

...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad_prep/wo/populate_product_list(scale)
	listed_products = list(
		...
		list("Box of Buckshot Shells (12g)", floor(scale * 10), /obj/item/ammo_magazine/shell_box/gauge_12/buckshot, VENDOR_ITEM_REGULAR),
		list("Box of Flechette Shells (12g)", floor(scale * 4), /obj/item/ammo_magazine/shell_box/gauge_12/flechette, VENDOR_ITEM_REGULAR),
		list("Box of Shotgun Slugs (12g)", floor(scale * 10), /obj/item/ammo_magazine/shell_box/gauge_12/slug, VENDOR_ITEM_REGULAR),
		...
		list("M4A3 Magazine (9mm)", floor(scale * 25), /obj/item/ammo_magazine/m4a3, VENDOR_ITEM_REGULAR),

...
/datum/faction/clf/get_antag_guns_snowflake_equipment()
	return list(
		...
		list("Box Of Buckshot Shells", 10, /obj/item/ammo_magazine/gauge_12/buckshot, null, VENDOR_ITEM_REGULAR),
		list("Box Of Flechette Shells", 10, /obj/item/ammo_magazine/gauge_12/flechette, null, VENDOR_ITEM_REGULAR),
		list("Box Of Shotgun Slugs", 10, /obj/item/ammo_magazine/gauge_12/slug, null, VENDOR_ITEM_REGULAR),
...
/datum/faction/clf/get_antag_guns_sorted_equipment()
	return list(
		...
		list("ABR-40 Magazine (10x24mm)", 20, /obj/item/ammo_magazine/rifle/l42a/abr40, null, VENDOR_ITEM_REGULAR),
		list("Basira-Armstrong Magazine (6.5mm)", 5, /obj/item/ammo_magazine/rifle/boltaction, null, VENDOR_ITEM_REGULAR),
		list("Box Of Buckshot Shells", 15, /obj/item/ammo_magazine/gauge_12/buckshot, VENDOR_ITEM_REGULAR),
		list("Box Of Flechette Shells", 15, /obj/item/ammo_magazine/gauge_12/flechette, VENDOR_ITEM_REGULAR),
		list("Box Of Shotgun Slugs", 15, /obj/item/ammo_magazine/gauge_12/slug, VENDOR_ITEM_REGULAR),

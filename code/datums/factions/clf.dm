...
/datum/faction/clf/get_antag_guns_snowflake_equipment()
	return list(
		...
		list("Double Barrel Shotgun", 30, /obj/item/weapon/gun/shotgun/double/spearhead, null, VENDOR_ITEM_REGULAR),
		list("HG 37-12 Pump Shotgun", 30, /obj/item/weapon/gun/shotgun/double/spearhead/sawn, null, VENDOR_ITEM_REGULAR),
		...
		list("Box Of Buckshot Shells", 10, /obj/item/ammo_magazine/shell_box/gauge_12/buckshot, null, VENDOR_ITEM_REGULAR),
		list("Box Of Flechette Shells", 10, /obj/item/ammo_magazine/shell_box/gauge_12/flechette, null, VENDOR_ITEM_REGULAR),
		list("Box Of Shotgun Slugs", 10, /obj/item/ammo_magazine/shell_box/gauge_12/slug, null, VENDOR_ITEM_REGULAR),
		...
		list("Holdout Pistol", 10, /obj/item/weapon/gun/pistol/w62, null, VENDOR_ITEM_REGULAR),
...
/datum/faction/clf/get_antag_guns_sorted_equipment()
	return list(
		...
		list("ABR-40 Hunting Rifle", 30, /obj/item/weapon/gun/rifle/l42a/abr40, null, VENDOR_ITEM_REGULAR),
		list("Basira-Armstrong Bolt-Action", 15, /obj/item/weapon/gun/bolt_action/basira_armstrong, null, VENDOR_ITEM_REGULAR),
		list("Double Barrel Shotgun", 20, /obj/item/weapon/gun/shotgun/double/spearhead, VENDOR_ITEM_REGULAR),
		list("HG 37-12 Pump Shotgun", 20, /obj/item/weapon/gun/shotgun/double/spearhead/sawn, VENDOR_ITEM_REGULAR),
		...
		list("ABR-40 Magazine (10x24mm)", 20, /obj/item/ammo_magazine/rifle/l42a/abr40, null, VENDOR_ITEM_REGULAR),
		list("Basira-Armstrong Magazine (6.5mm)", 5, /obj/item/ammo_magazine/rifle/boltaction, null, VENDOR_ITEM_REGULAR),
		list("Box Of Buckshot Shells", 15, /obj/item/ammo_magazine/shell_box/gauge_12/buckshot, VENDOR_ITEM_REGULAR),
		list("Box Of Flechette Shells", 15, /obj/item/ammo_magazine/shell_box/gauge_12/flechette, VENDOR_ITEM_REGULAR),
		list("Box Of Shotgun Slugs", 15, /obj/item/ammo_magazine/shell_box/gauge_12/slug, VENDOR_ITEM_REGULAR),
		...
		list("Holdout Pistol", 20, /obj/item/weapon/gun/pistol/w62, VENDOR_ITEM_REGULAR),
